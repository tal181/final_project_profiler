...
class CommandLineArgs(args: Seq[String]) extends ScallopConf(args)  {
  ...
  private val dataSetPathArg = opt[String]("dataSetPath", required = true, default = Some("/Users/tsharon/IdeaProjects/final_project/src/main/resources/test_1.csv"))
  ...
  private val metricsConfigDeequPathArg = opt[String]("metricsConfigDeequPath", required = true, default = Some("metricsConfigDeequ.json"))
  ...
  val metricsConfigDeequPath: String = {
    val metricsConfigDeequPath: String = metricsConfigDeequPathArg()
    Logger.debug(s"metricsConfigDeequPathArg $metricsConfigDeequPathArg")
    metricsConfigDeequPath
  }
